  ...
  <div class="componente">
    <div class="tela-cadastro-usuario">
      <div class="titulo-cadastro">
        <h2 class="titulo-update-user">Atualize seus dados.</h2>
      </div>
      <div class="cadastro-componente-1">
        <div class="componente-cadastro-1">
          <InputText
            v-model="usuarioAtualizado.nome"
            type="text"
            placeholder="Nome"
        ...
        <div class="componente-cadastro-2">
          <InputNumber
            v-model="usuarioAtualizado.idade"
            invalid
            mode="decimal"
            :min="0"
            class="input-cadastros"
      ...
      <div class="cadastro-componente-2">
        <div class="componente-cadastro-2">
          <InputText
            v-model="usuarioAtualizado.email"
            type="text"
            class="input-cadastros"
            placeholder="Email"
          />
        ...
        <div class="componente-cadastro-3">
          <InputMask
            id="phone"
            v-model="usuarioAtualizado.telefone"
            mask="(99) 99999-9999"
