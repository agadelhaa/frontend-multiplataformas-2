<template>
  <div
    ...
    "
  >
    <Button label="+" @click="visible = true" class="cadastro" />
        ...
        <div class="inline-flex flex-column gap-2">
          <div class="cadastro-componente-1">
            <div class="componente-cadastro-1">
              <label for="nome-produto" class="campo-label"
                >Nome do pet <i class="pi pi-pencil" style="font-size: 1rem"></i
              ></label>
              <input
                type="text"
                v-model="pet.nome"
          ...
          <div class="cadastro-componente-2">
            <div class="componente-cadastro-2">
              ...
              <input
                type="text"
                v-model="pet.historicoMedico"
                placeholder="doença médica"
                class="input-componente form-control"
                :class="{ 'input-vazio': !pet.historicoMedico }"
              />
            </div>
      ...
      switch (true) {
        ...
        default: {
          try {
            ...
            mensagem =
              'Ocorreu um erro ao salvar o seu produto, verifique se os campos estão preenchidos corretamente';
          }
        }
      }
...
.cadastro:hover {
  background-color:#3c8f7d !important;
