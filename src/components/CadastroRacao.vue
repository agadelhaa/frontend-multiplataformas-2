<!-- <template>
    <div class="cadastro-racao">
        <div class="cadastro">
            ...
            <Input type="number" v-model="racao.kqQuantidade" placeholder="Quilo" showButtons :min="0" class="input-componente"/>
            ...
            <div class="cancelar-salvar">
                <Button  label="Enviar" severity="success" @click="salvarRacao()" class="enviar">SALVAR <i class="pi pi-check" style="font-size: 1rem"></i></Button>
                <Button label="Cancelar" severity="danger"  class="cancelar" @click="cancelar">Cancelar <i class="pi pi-times" style="font-size: 1rem"></i></Button>
...
<template>
    <div class="card flex justify-content-center" style="background-color: black;">
        <Button label="RAÇÃO" icon="pi pi-user" @click="visible = true" />
...
>
            ...
            <div class="componente-cadastro-2"> 
                <label for="" class="campo-label">Quilos Kg</label>
                <InputNumber v-model="racao.kqQuantidade"  mode="currency" currency="BRL" :min="0" class="input-componente" />
